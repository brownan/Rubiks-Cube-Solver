...
static char turn_position_lookup[20][18] = {
    ...
    /* 9 */ { 9,9,4,9,14,9,  9,9,16,9,2,9,  9,9,11,9,10,9},
            { 10,10,10,10,2,17,  10,10,10,10,14,5,  10,10,10,10,9,12},
            { 11,7,16,11,11,11,  11,19,4,11,11,11,  11,12,9,11,11,11},
            { 12,19,12,12,12,5,  12,7,12,12,12,17,  12,11,12,12,12,10},
    /* 13 */{ 18,13,1,13,15,13,  15,13,18,13,1,13,  20,13,6,13,3,13},
            { 16,14,14,14,10,14, 17,14,14,14,9,14,  19,14,14,14,2,14},
            { 13,15,15,15,3,20,  20,15,15,15,13,3,  18,15,15,15,1,8},
    /* 16 */{ 19,16,9,16,16,16,  14,16,11,16,16,16, 17,16,4,16,16,16},
            { 14,17,17,17,17,12, 19,17,17,17,17,10, 16,17,17,17,17,5},
    /* 18 */{ 20,6,13,18,18,18,  13,20,6,18,18,18,  15,8,1,18,18,18},
            { 17,11,19,19,19,19, 16,12,19,19,19,19, 14,7,19,19,19,19},
            { 15,18,20,20,20,8,  18,8,20,20,20,15,  13,6,20,20,20,3},
};
